   ...
   $conn = new mysqli($dbHost, $dbUsername, $dbPassword, $dbName);
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if(!empty($data)){
            ...
            $insert = "INSERT INTO bracelet_data (anchor_id, position, heart_rate, body_temperature, blood_pressure, high_values) VALUES ('" . $pattern[0] . "', '" . $pattern[1] . "', '" . $pattern[2] . "', '" . $pattern[3] . "', '" . $pattern[4] . "', '" . $pattern[5] . "')";
...
<body>
    ...
    <div id="dati">
        ...
        <div class="dati-row">
            ...
            <div class="dati-item">Position:</div>
            <div class="dati-item">BPM:</div>
            <div class="dati-item">Temperature:</div>
            <div class="dati-item">Blood Pressure:</div>
        </div>
        <?php
        ...
        if($result->num_rows > 0){
            while($row = $result->fetch_assoc()){
                ...
                if($row["high_values"]  == "1"){
                    ...
                    echo "<div class='dati-elem' style='color: red'>" . $row["position"] . "</div>";
                    echo "<div class='dati-elem' style='color: red'>" . $row["heart_rate"] . "</div>";
                    echo "<div class='dati-elem' style='color: red'>" . $row["body_temperature"] . "</div>";
                    echo "<div class='dati-elem' style='color: red'>" . $row["blood_pressure"] . "</div>";
                    }
                    else{
                        echo "<div class='dati-elem'>" . $row["id"] . "</div>";
                        echo "<div class='dati-elem'>" . $row["anchor_id"] . "</div>";
                        echo "<div class='dati-elem'>" . $row["position"] . "</div>";
                        echo "<div class='dati-elem'>" . $row["heart_rate"] . "</div>";
                        echo "<div class='dati-elem'>" . $row["body_temperature"] . "</div>";
                        echo "<div class='dati-elem'>" . $row["blood_pressure"] . "</div>";
                    }
